# 11_Results — Deliverables (complete)
...
- Every file in Results should have PI_Review_Status = Approved (or equivalent) and be listed in `00_Governance/Authorship_Log.md` where applicable.

**Governance:** Only PI-approved, committee-ready deliverables. Front-matter (AI_Assisted, Model_Used, Prompt_Summary, PI_Review_Status) per `00_Governance/AI_Use_Disclosure.md`. Authorship_Log updated for committee-facing items.
