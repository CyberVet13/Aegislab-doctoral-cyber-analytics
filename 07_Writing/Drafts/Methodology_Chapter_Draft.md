...
*Source: 03_Research_Methods/Research_Design/Methodology_Framework_v1.md, Validity_Frameworks/Threats_and_Mitigations.md, Analysis_Plan.md. PI must verify citations and approve before submission.*
...
[*Insert institutional IRB status: approved, exempt, or not required, with rationale.*] Data handling follows [*00_Governance and Metrics_Definitions*]; no PII in the evaluation path without approval. Cybersecurity research is conducted within authorized scope only; no offensive or unauthorized testing [*Ethical_Boundaries_Statement*].
